...
import { KbFullscreenDirective } from './fullscreen.directive';
import { BrowserDynamicTestingModule, platformBrowserDynamicTesting } from '@angular/platform-browser-dynamic/testing';
import { By } from '@angular/platform-browser';

@Component({
  template: `
    <div kbFullScreen #myDirective="kbFullScreen">
...
class KbFullscreenTestComponent {}

describe('KbFullscreenDirective', () => {
  let fixture: ComponentFixture<KbFullscreenTestComponent>;
  let btnEl: DebugElement;
  let btnExit: DebugElement;
  let directiveEl: DebugElement;
  let directive: KbFullscreenDirective;

  beforeEach(() => {
    TestBed.resetTestEnvironment();
    TestBed.initTestEnvironment(BrowserDynamicTestingModule, platformBrowserDynamicTesting());
    TestBed.configureTestingModule({
      declarations: [KbFullscreenTestComponent, KbFullscreenDirective],
    }).compileComponents();

    fixture = TestBed.createComponent(KbFullscreenTestComponent);
    btnEl = fixture.debugElement.query(By.css('#test-btn'));
    btnExit = fixture.debugElement.query(By.css('#test-btn-exit'));
    directiveEl = fixture.debugElement.query(By.directive(KbFullscreenDirective));
    directive = directiveEl.injector.get(KbFullscreenDirective);
  });
