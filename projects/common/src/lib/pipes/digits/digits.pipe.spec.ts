import { KbDigitsPipe } from './digits.pipe';
...
describe('KbDigitsPipe', () => {
  let pipe: KbDigitsPipe;
  let l10nEsPipe: KbDigitsPipe;
  let l10nFrPipe: KbDigitsPipe;
  beforeEach(() => {
    pipe = new KbDigitsPipe();
    l10nEsPipe = new KbDigitsPipe('es');
    l10nFrPipe = new KbDigitsPipe('fr');
  });
