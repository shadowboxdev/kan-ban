...
export enum KbNotificationCountPositionY {
  Top = 'top',
  Bottom = 'bottom',
  Center = 'center',
}

export enum KbNotificationCountPositionX {
  Before = 'before',
  After = 'after',
  Center = 'center',
}
...
@Component({
  selector: 'kb-notification-count',
  styleUrls: ['./notification-count.component.scss'],
  templateUrl: './notification-count.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class KbNotificationCountComponent implements AfterContentInit {
  private _notifications: number | boolean = 0;
  private _positionY: KbNotificationCountPositionY;
  private _positionX: KbNotificationCountPositionX;
   ...
   */
  @Input()
  set positionX(positionX: KbNotificationCountPositionX) {
    this._positionX = positionX;
  }
  get positionX(): KbNotificationCountPositionX {
   ...
   */
  @Input()
  set positionY(positionY: KbNotificationCountPositionY) {
    this._positionY = positionY;
  }
  get positionY(): KbNotificationCountPositionY {
  ...
  @HostBinding('class.kb-notification-hidden')
  ...
  ngAfterContentInit(): void {
    if (!this._positionX) {
      this.positionX = this._hasContent() ? KbNotificationCountPositionX.After : KbNotificationCountPositionX.Center;
    }
    if (!this._positionY) {
      this.positionY = this._hasContent() ? KbNotificationCountPositionY.Top : KbNotificationCountPositionY.Center;
    }
  }
