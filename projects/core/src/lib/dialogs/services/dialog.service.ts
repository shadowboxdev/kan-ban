...
export class KbDialogService {
   ...
   * Returns an MatDialogRef<KbAlertDialogComponent> object.
   */
  public openAlert(config: IAlertConfig): MatDialogRef<KbAlertDialogComponent> {
    const dialogConfig: MatDialogConfig = this._createConfig(config);
    const dialogRef: MatDialogRef<KbAlertDialogComponent> = this._dialogService.open(
      KbAlertDialogComponent,
      dialogConfig,
    );
    const alertDialogComponent: KbAlertDialogComponent = dialogRef.componentInstance;
   ...
   * Returns an MatDialogRef<KbConfirmDialogComponent> object.
   */
  public openConfirm(config: IConfirmConfig): MatDialogRef<KbConfirmDialogComponent> {
    const dialogConfig: MatDialogConfig = this._createConfig(config);
    const dialogRef: MatDialogRef<KbConfirmDialogComponent> = this._dialogService.open(
      KbConfirmDialogComponent,
      dialogConfig,
    );
    const confirmDialogComponent: KbConfirmDialogComponent = dialogRef.componentInstance;
   ...
   * Returns an MatDialogRef<KbPromptDialogComponent> object.
   */
  public openPrompt(config: IPromptConfig): MatDialogRef<KbPromptDialogComponent> {
    const dialogConfig: MatDialogConfig = this._createConfig(config);
    const dialogRef: MatDialogRef<KbPromptDialogComponent> = this._dialogService.open(
      KbPromptDialogComponent,
      dialogConfig,
    );
    const promptDialogComponent: KbPromptDialogComponent = dialogRef.componentInstance;
